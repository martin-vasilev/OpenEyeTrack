export interface EyeTrackingSample {
  ...
  faceConfidence: number | null; eyeConfidence: number | null;
  elgLeftRelX: number | null; elgLeftRelY: number | null; elgRightRelX: number | null; elgRightRelY: number | null;
  elgLeftConfidence: number | null; elgRightConfidence: number | null; elgInferenceMs: number | null; elgTimestampMs: number | null;
  elgAgeMs: number | null; elgSequenceId: number | null; elgAcquisitionTimestampMs: number | null; elgProcessedTimestampMs: number | null;
  elgLatencyMs: number | null; elgQueueDepth: number | null; elgLeftRelXRaw: number | null; elgLeftRelYRaw: number | null;
  elgRightRelXRaw: number | null; elgRightRelYRaw: number | null; elgBinocularReliability: number | null;
