...
type FirstEye="left"|"right";
type QueueJob={sequenceId:number;acquisitionTimestampMs:number;enqueuedAtMs:number;cropPreprocessMs:number;inputBufferAcquireMs:number;firstEye:FirstEye;leftTiming:CropTiming;rightTiming:CropTiming;input:Float32Array;resolve:(v:ElgEyeFeatures|null)=>void;reject:(e:unknown)=>void};
...
export class ElgEyeTracker {
  ...
  get activeBackend(){return this.backend;} get activeAcquisitionMode(){return this.acquisitionMode;}
